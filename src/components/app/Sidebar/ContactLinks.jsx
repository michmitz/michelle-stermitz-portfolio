...
export default function ContactLinks() {
  return (
    <div className={contactLinkStyles.contactDiv}>
      ...
      <a href="https://github.com/michmitz">
        <img className={contactLinkStyles.githubIcon} src="/assets/github-logo-white.png" alt="/assets/github-logo-white.png" />
        /michmitz</a>
      <a href="https://linkedin.com/in/michellestermitz">
        <img className={contactLinkStyles.icon} src="/assets/linkedin-white.png" alt="/assets/linkedin-white.png" /> 
        LinkedIn</a>
      <a href="https://twitter.com/michmitzpdx">
